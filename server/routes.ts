...
import { 
  ...
  getOpenMeteoHistorical,
  getOpenMeteoFloodRisk,
  getOpenMeteoPollen,
...
const processRequestHandler = (req: Request, res: Response): void => {
  try {
...
export async function registerRoutes(app: Express): Promise<any> {
  ...
  async function getDeviceIdFromRequest(req: Request): Promise<string> {
  ...
  app.get("/api/weather/air-quality/forecast", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error fetching air quality forecast:", error);
  ...
  app.get("/api/weather/air-quality/historical", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error fetching historical air quality data:", error);
  ...
  app.get("/api/climate/flood-risk", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error fetching flood risk data:", error);
  ...
  app.get("/api/climate/projections", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error generating climate projections:", error);
  ...
  app.get("/api/weather/recommendations/clothing", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error generating clothing recommendations:", error);
  ...
  app.get("/api/activities/time-slots", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error generating optimal time slots:", error);
  ...
  app.get("/api/activities/outdoor", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error fetching outdoor activities:", error);
  ...
  app.get("/api/activities/indoor", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error fetching indoor activities:", error);
  ...
  app.get("/api/sustainability/tips", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error fetching sustainability tips:", error);
  ...
  app.get("/api/sustainability/initiatives", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error fetching community initiatives:", error);
  ...
  app.get("/api/sustainability/polls", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error fetching sustainability polls:", error);
  ...
  app.get("/api/sustainability/ideas", async (req: Request, res: Response) => {
    try {
      ...
      logger.error("Error fetching community ideas:", error);
  ...
  app.get("/api/chat/history", async (req: Request, res: Response) => {
    try {
      ...
      try {
        ...
        logger.error("Error fetching device-specific chat history:", error);
        res.status(500).json({ 
      ...
      logger.error("Error processing chat history request:", error);
  ...
  async function getCurrentAirQualityData(): Promise<any> {
    try {
      ...
      logger.error("Error fetching current air quality data:", error);
      return null;
    }
  }
...
app.get("/api/some-route", async (req: Request, res: Response) => {
  try {
